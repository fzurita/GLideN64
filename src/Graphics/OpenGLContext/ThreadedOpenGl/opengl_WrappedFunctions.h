...
namespace opengl {
	...
	public:
		...
		void commandToExecute() override
		{
			ptrDeleteFramebuffers(m_n, m_framebuffers.get());
		}
	private:
	...
	public:
		...
		void commandToExecute() override
		{
			ptrDeleteRenderbuffers(m_n, m_renderbuffers.get());
		}
	private:
	...
	public:
		...
		void commandToExecute() override
		{
			ptrDeleteVertexArrays(m_n, m_arrays.get());
		}
	private:
	...
	public:
		...
		void commandToExecute() override
		{
			ptrBufferData(m_target, m_size, m_data.get(), m_usage);
		}
	private:
	...
	public:
		...
		void commandToExecute() override
		{
			ptrDeleteBuffers(m_n, m_buffers.get());
		}
	private:
	...
	public:
		...
		void commandToExecute() override
		{
			ptrInvalidateFramebuffer(m_target, m_numAttachments, m_attachments.get());
		}
	private:
	...
	public:
		...
		void commandToExecute() override
		{
			ptrBufferStorage(m_target, m_size, m_data.get(), m_flags);
		}
	private:
	...
	public:
		...
		void commandToExecute() override
		{
			ptrBufferSubData(m_target, m_offset, m_size, m_data.get());
		}
	private:
	...
	public:
		...
		void commandToExecute() override
		{
			ptrProgramBinary(m_program, m_binaryFormat, m_binary.get(), m_length);
		}
	private:
